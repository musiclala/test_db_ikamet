...
class Property(models.Model):
    ...
    latitude = models.DecimalField(max_digits=22, decimal_places=16, verbose_name="Широта WGS 84, градусы")
    longitude = models.DecimalField(max_digits=22, decimal_places=16, verbose_name="Долгота WGS 84, градусы")
    ...
    layouts = models.ManyToManyField('Layouts', blank=True, null=True, verbose_name='layouts')
    features = models.ManyToManyField('Features', blank=True, null=True, verbose_name='features')
...
class Manager(models.Model):
    ...
    partner = models.IntegerField(verbose_name='Partners', blank=True, default=1)
    created_at = models.DateTimeField(verbose_name='Дата создания', auto_now_add=True)
    updated_at = models.DateTimeField(verbose_name='Дата изменения', auto_now=True)
